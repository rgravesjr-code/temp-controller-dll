...
if errorlevel 1 exit /b 1
call :zigbuild armhf "arm-linux-gnueabihf.2.24 -mcpu=cortex_a9" "32-bit ARM NI Linux RT / myRIO-1900"
if errorlevel 1 exit /b 1
...
:: %1 dir tag (x64|arm64|armhf)  %2 zig target triple (+ extra cc flags)  %3 description
:zigbuild
setlocal
set "TAG=%~1"
set "TARGET=%~2"
